...
$require = array("お問い合わせ項目","お名前","フリガナ","メールアドレス");
...
$re_subject = "hair resort Ai お問い合わせありがとうございます";
...
<body>
    ...
    <div class="p-header__inner l-inner">
      ...
      <div class="p-header__drawer">
        ...
        <div class="p-entry__block p-cv">
          ...
          <a class="p-cv__entry" href="#entry-form">entry<span>ご応募</span></a>
  ...
  <section class="p-contact2">
    <div class="p-contact2__inner">
      <h1 class="p-contact2__title c-section-title">#contact</h1>
      <div class="p-contact2__form">
        <form action="<?php echo h($_SERVER['SCRIPT_NAME']); ?>" method="POST">
          <p class="p-contact2__sub">送信内容確認</p>
          <div id="formWrap">
            <?php if($empty_flag == 1){ ?>
            <div align="center">
          ...
          <p class="p-contact2__list1">お問い合わせ項目<br><?php echo $_POST['お問い合わせ項目']; ?></p>
          <div class="p-contact2__border"></div>
          <p class="p-contact2__list">お名前*<br><?php echo $_POST['お名前']; ?></p>
          <div class="p-contact2__border"></div>
          <p class="p-contact2__list">フリガナ*<br><?php echo $_POST['フリガナ']; ?></p>
          <div class="p-contact2__border"></div>
          <p class="p-contact2__list3">お問い合わせ内容</p>
          <p class="p-contact2__text">
            <?php echo $_POST['お問い合わせ内容']; ?>
          </p>
        ...
        <form action="mail_contact.php" method="post">
          ...
          <p class="p-entry-form__button"><input type="submit" value="確認"></p>
          <input type="hidden" name="mail_set" value="confirm_submit">
          <input type="hidden" name="httpReferer" value="<?php echo h($_SERVER['HTTP_REFERER']);?>">
        </form>
      </div>
    </div>
    <div class="p-contact2__snsarea">
      <div class="p-contact__line">
        <img src="./images/line3.png" alt="" />
      </div>
      <div class="p-contact__insta">
        <img src="./images/insta3.png" alt="" />
      </div>
    </div>
  </section>
