    ...
    <div class="lp-wrap">
        ...
        <main>
            ...
            <div class="contact-complete">
                <div class="contact-complete__wrap">
                    <!-- 返信ありがとうございます -->
                    <h2 class="contact-complete__title">送信ありがとうございます</h2>
                    <p class="contact-complete__text">この度はご応募いただきありがとうございます。<br>
                        通常2時間以内にご返信させていただいております。<br>
                        万が一、返信がない場合はお手数ですが<br>
                        お電話にてご連絡ください。</p>
                    ...
                    <div class="contact-flow">
                        ...
                        <div class="contact-flow__position">確認</div>
                        <div class="contact-flow__line"></div>
                        <div class="contact-flow__position show">完了</div>
                    </div>
    
                    <!-- back to top -->
                    <a href="#" class="contact-complete__back">BACK TO TOP</a>
